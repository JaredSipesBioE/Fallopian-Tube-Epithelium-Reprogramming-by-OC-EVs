...
SampleAnnotationFile <- 
    dir(file.path(datadir, "annotation"), pattern = "temp.xlsx$",
        full.names = TRUE, recursive = TRUE)
...
Sankey_D14 <- plot_sankey(count_mat = dplyr::count(pData(dataEV_D14), Tissue, Treatment, Segment))


Sankey_D1 <- plot_sankey(count_mat = dplyr::count(pData(dataEV_D01), Tissue, Treatment, Segment))
